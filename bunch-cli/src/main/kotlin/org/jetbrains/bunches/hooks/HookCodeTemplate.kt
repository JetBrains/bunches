...
internal const val HOOK_LAUNCH_COMMAND = "hook-launch"
...
fun preRebaseHookTemplate(bunchExecutablePath: File, oldHookPath: String, repoPath: File): String {
    return """
        ...
        '${bunchExecutablePath.absolutePath}' $HOOK_LAUNCH_COMMAND $BUNCH_PRE_REBASE_CHECK_COMMAND ${'$'}1 ${'$'}two ${repoPath.absolutePath} ${'$'}mode
